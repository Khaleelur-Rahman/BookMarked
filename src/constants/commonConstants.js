...
export const API_PATH = (bookName, author) =>
  `https://www.googleapis.com/books/v1/volumes?q=${bookName}+inauthor:${author}&maxResults=40&printType=books&key=${process.env.REACT_APP_GOOGLEBOOKS_API_KEY}`;
