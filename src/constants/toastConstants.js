...
export const TOAST_EMAIL_IN_USE = (email) =>  `Email address ${email} is already in use!`;
export const TOAST_INVALID_EMAIL = (email) =>  `Email Address ${email} is invalid!`;

// toast messages for invalid op
export const TOAST_USER_NOT_FOUND = "User not found! Try using a different email and password.";
